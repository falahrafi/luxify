...
<div class="d-sm-flex align-items-center justify-content-between">
   <h1 class="h3 mb-0 text-black"><b>Pesan Pengguna</b> <i class="fas fa-envelope fa-sm"></i></h1>
            ...
            <tbody>
               ...
               ?>
                  ...
                  <tr>
                     ...
                     <td>
                        <div>
                           <a href="functions/contact_us/hapus.php?id=<?= $contact['id']; ?>" class="btn btn-circle btn-red btn-action" role="button" title="Hapus Data">
